...
· Практика: Работа с IFormFile, публикация/потребление сообщений через RabbitMQ, транзакционность (если бы не было очереди).
...
· Практика: Кеширование данных в Redis, gRPC-вызовы.
...
· Практика: Настройка маршрутов и трансформаций в Yarp для обхода основного бэкенда. Это критически важный навык для разгрузки сервисов.
